...
### Backwards incompatible changes
  ...
  - Stateful Component templates now requires a `phx-target="<%= @id %>"` on the wrapper element in order to support passing a path to the `render_*` test functions, eg:
  ...
  Note this API is deprecated and you should migrate to the new element based API.
