...
which is included by default in the [`esbuild`](https://esbuild.hexdocs.pm) configuration of new
...
controller](https://phoenix.hexdocs.pm/controllers.html#rendering) — pages with no
