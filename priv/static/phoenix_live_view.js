var LiveView = (() => {
  ...
  var RELOAD_FAILSAFE_JITTER = 3e4;
  var CONSECUTIVE_REDIRECTS = "consecutive-redirects";
  var MAX_REDIRECTS = 3;
  var REDIRECT_JITTER_MIN = 1e3;
  var REDIRECT_JITTER_MAX = 5e3;
  var REDIRECT_FAILSAFE_JITTER = 2e4;
...
`);
  ...
  var View = class _View {
    ...
    redirectWithJitter() {
      ...
      let redirectAttempts = browser_default.updateLocal(this.localStorage, window.location.pathname, CONSECUTIVE_REDIRECTS, 0, (count) => count + 1);
